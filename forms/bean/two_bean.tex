...
\newcommand{\myXtwobeanXZeroXIdentifier}[0]{
two bean
}

\newcommand{\myXtwobeanXZeroXAcontent}[0]{
\includegraphics[angle=00,width=0.44\paperwidth]{two_bean.png}
}

\newcommand{\myXtwobeanXZeroXBcontent}[0]{
\includegraphics[angle=00,width=0.44\paperwidth]{two_bean.png}
}

\newcommand{\myXtwobeanXZeroXCcontent}[0]{
\includegraphics[angle=00,width=0.44\paperwidth]{two_bean.png}
}
...
\mycard{}{\myXtwobeanXZeroXIdentifier}{
\myXtwobeanXZeroXAcontent
}{}{} 
\end{textblock}
...
% \begin{textblock}{8}(8,4)
% \textblocklabel{picture7}
% \mycard{}{\myXtwobeanXZeroXIdentifier}{\parbox{9.0cm}{D:
% \myDcontent
% }}{}{} 
% \end{textblock}
