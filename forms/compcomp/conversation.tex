...
% \textblockrulecolor{red}
	...
	\vspace{0.09cm}
	\normalsize I. \rule{1.1cm}{0.3pt} Champion: \rule{1.5cm}{0.3pt}\\
	\vspace{0.25cm}
	\normalsize II. \rule{1.0cm}{0.3pt} Champion: \rule{1.5cm}{0.3pt}\\
	\vspace{0.25cm}
	\large Winner: \rule{2.1cm}{0.3pt}\\
	\large Votes:\\
	\normalsize I. \rule{1.2cm}{0.3pt} Names: \rule{1.2cm}{0.3pt}, \rule{1.2cm}{0.3pt}, \rule{1.2cm}{0.3pt}\\
	\vspace{0.25cm}
	\normalsize II. \rule{1.2cm}{0.3pt} Names: \rule{1.2cm}{0.3pt}, \rule{1.2cm}{0.3pt}, \rule{1.2cm}{0.3pt}\\
	\large Reasons:\\
	\normalsize Winner's Supporters\\
	\tiny Name: \rule{1.0cm}{0.3pt} \normalsize Reason: \rule{4.0cm}{0.3pt}\\
	\vspace{0.25cm}
	\tiny Name: \rule{1.0cm}{0.3pt} \normalsize Reason: \rule{4.0cm}{0.3pt}\\
	\vspace{0.25cm}
	\tiny Name: \rule{1.0cm}{0.3pt} \normalsize Reason: \rule{4.0cm}{0.3pt}\\
